...
class Anonymous_Struct_635 < Struct
  def name; end
  def name=(_); end
  def relation; end
  def relation=(_); end
...
class Arel::Attributes::Attribute < Anonymous_Struct_635
  def able_to_type_cast?; end
  def lower; end
...
class Anonymous_Struct_636 < Struct
  def from; end
  def from=(_); end
  def name; end
  def name=(_); end
...
class Arel::Visitors::Dot::Edge < Anonymous_Struct_636
end
...
class ActiveRecord::Type::Time::Value < Anonymous_Delegator_637
end
...
class ActiveRecord::Type::Serialized < Anonymous_Delegator_638
  def accessor; end
...
class ActiveRecord::Core::InspectionMask < Anonymous_Delegator_639
  def pretty_print(pp); end
end
...
class ActiveRecord::Locking::LockingType < Anonymous_Delegator_640
  def deserialize(value); end
  def encode_with(coder); end
  def init_with(coder); end
  def serialize(value); end
...
class ActiveRecord::AttributeMethods::TimeZoneConversion::TimeZoneConverter < Anonymous_Delegator_641
  def cast(value); end
