...
class InvalidName___Class_0x00___Differ_642
end
...
class Anonymous_Struct_643 < Struct
  def actual; end
  def actual=(_); end
  def expected; end
  def expected=(_); end
...
class RSpec::Matchers::BuiltIn::Exist::ExistenceTest < Anonymous_Struct_643
...
class Anonymous_Struct_644 < Struct
  def name; end
  def name=(_); end
  def self.[](*arg0); end
  def self.inspect; end
...
class RSpec::Matchers::BuiltIn::CaptureStreamToTempfile < Anonymous_Struct_644
