...
class Anonymous_Struct_647 < Struct
  def callable; end
  def callable=(_); end
  def self.[](*arg0); end
  def self.inspect; end
...
class VCR::RequestMatcherRegistry::Matcher < Anonymous_Struct_647
  def matches?(request_1, request_2); end
end
class Anonymous_Struct_648 < Struct
...
class VCR::RequestMatcherRegistry::URIWithoutParamsMatcher < Anonymous_Struct_648
...
class Anonymous_Struct_649 < Struct
  def body; end
  def body=(_); end
  def headers; end
  def headers=(_); end
...
class VCR::Request < Anonymous_Struct_649
  def initialize(*args); end
  def method(*args); end
  def parsed_uri; end
...
class VCR::Request::Typed < Anonymous_Delegator_650
...
class VCR::Request::FiberAware < Anonymous_Delegator_651
  def proceed; end
  def to_proc; end
end
class Anonymous_Struct_652 < Struct
...
class VCR::Response < Anonymous_Struct_652
  def compressed?; end
...
class Anonymous_Struct_653 < Struct
  def code; end
  def code=(_); end
  def message; end
  def message=(_); end
...
class VCR::ResponseStatus < Anonymous_Struct_653
  def self.from_hash(hash); end
  def to_hash; end
end
class Anonymous_Struct_654 < Struct
  def recorded_at; end
...
class VCR::HTTPInteraction < Anonymous_Struct_654
  def hook_aware; end
  def initialize(*args); end
  def self.from_hash(hash); end
  def to_hash; end
end
class VCR::HTTPInteraction::HookAware < Anonymous_Delegator_655
