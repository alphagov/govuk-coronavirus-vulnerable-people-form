...
class WebMock::HttpLibAdapters::ExconAdapter < WebMock::HttpLibAdapter
  def self.add_excon_stub; end
  def self.body_from(params); end
  def self.build_request(params); end
  def self.connection_params_from(hash); end
  def self.disable!; end
  def self.enable!; end
  def self.handle_request(params); end
  def self.mock_response(real); end
  def self.new_excon_connection(params); end
  def self.perform_callbacks(request, response, options = nil); end
  def self.real_response(mock); end
  def self.remove_excon_stub; end
  def self.request_params_from(hash); end
  def self.to_query(hash); end
end
class Excon::Connection
  def self.new(args = nil); end
end
