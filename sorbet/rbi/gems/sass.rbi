...
class Anonymous_Struct_630 < Struct
  def input; end
  def input=(_); end
  def output; end
  def output=(_); end
...
class Sass::Source::Map::Mapping < Anonymous_Struct_630
  def inspect; end
end
module Sass::Tree
end
...
class Anonymous_Struct_631 < Struct
  def children; end
  def children=(_); end
...
class Sass::Engine::Line < Anonymous_Struct_631
  def comment?; end
end
